...
namespace DatabaseVersioningTool.DataAccess
{
    public interface IDatabaseManager
    {
        ...
        string GetDatabaseVersion(DatabaseConnection dbAccess);
        IEnumerable<string> GetDatabaseNames(DatabaseConnection dbAccess);
        void RestoreDatabase(DatabaseConnection dbAccess, string dbName, string filePath);
        void BackUpDatabase(DatabaseConnection dbAccess, string path);
        void CreateDatabaseUpdate(DatabaseConnection dbAccess, string sql);

        void ValidateSQL(DatabaseConnection dbAccess, string sql);

        void UpgradeDatabaseToVersion(DatabaseConnection dbAccess, string targetVersion);
    }
